...
export class Sentry extends NPC {

    constructor(player, entityManager, gameMap) {

        super(player, new THREE.Color(0xb86914), 3, Entity.Shapes.Sphere);
        ...
        fireSeq.children.push(new BT.InRangeOfEntity(this, player, 35));
